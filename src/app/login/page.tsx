  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        ...
        {loginMethod === 'github' && (
          <div className="flex flex-col items-center space-y-4">
            <a href="http://localhost:3000/api/auth/signin?provider=github">登陆</a>
            <button onClick={() => signIn('github', { callbackUrl: '/profile' })} className="flex items-center space-x-2 px-6 py-3 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition-colors">
